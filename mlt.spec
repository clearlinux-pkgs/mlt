...
Source0  : https://github.com/mltframework/mlt/releases/download/v7.14.0/mlt-7.14.0.tar.gz
...
%prep
%setup -q -n mlt-7.14.0
cd %{_builddir}/mlt-7.14.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678139307
mkdir -p clr-build
pushd clr-build
