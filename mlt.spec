...
Version  : 7.10.0
Release  : 24
URL      : https://github.com/mltframework/mlt/releases/download/v7.10.0/mlt-7.10.0.tar.gz
Source0  : https://github.com/mltframework/mlt/releases/download/v7.10.0/mlt-7.10.0.tar.gz
...
%prep
%setup -q -n mlt-7.10.0
cd %{_builddir}/mlt-7.10.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667328197
mkdir -p clr-build
pushd clr-build
