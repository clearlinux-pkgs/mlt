...
Source0  : https://github.com/mltframework/mlt/releases/download/v7.32.0/mlt-7.32.0.tar.gz
...
%prep
%setup -q -n mlt-7.32.0
cd %{_builddir}/mlt-7.32.0
pushd ..
cp -a mlt-7.32.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746714449
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libmlt++-7.so.7.32.0
/V3/usr/lib64/libmlt-7.so.7.32.0
