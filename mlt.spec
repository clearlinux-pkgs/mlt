...
Source0  : https://github.com/mltframework/mlt/releases/download/v6.20.0/mlt-6.20.0.tar.gz
...
%prep
%setup -q -n mlt-6.20.0
cd %{_builddir}/mlt-6.20.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581990725
...
cp %{_builddir}/mlt-6.20.0/COPYING %{buildroot}/usr/share/package-licenses/mlt/3704f4680301a60004b20f94e0b5b8c7ff1484a9
cp %{_builddir}/mlt-6.20.0/src/modules/plus/ebur128/COPYING %{buildroot}/usr/share/package-licenses/mlt/2627ff03833f74ed51a7f43c55d30b249b6a0707
%make_install
