...
Source0  : https://github.com/mltframework/mlt/releases/download/v7.4.0/mlt-7.4.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1640015414
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/mlt-7.4.0/COPYING %{buildroot}/usr/share/package-licenses/mlt/3704f4680301a60004b20f94e0b5b8c7ff1484a9
cp %{_builddir}/mlt-7.4.0/src/modules/plus/ebur128/COPYING %{buildroot}/usr/share/package-licenses/mlt/2627ff03833f74ed51a7f43c55d30b249b6a0707
pushd clr-build
%make_install
popd
